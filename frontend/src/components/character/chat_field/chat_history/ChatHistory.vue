...
import { useTemplateRef, nextTick, onMounted, onBeforeUnmount } from 'vue';
...
const scrollRef: any = useTemplateRef('scroll-ref')
const sentinelRef: any = useTemplateRef('sentinel-ref')
