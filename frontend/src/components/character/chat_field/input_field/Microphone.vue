...
const float32ToInt16 = (float32Array: any) => {
...
const sendToBackend = async (arrayBuffer: any) => {
  // 将音频发送到后端
...
<template>
    <div class="absolute bottom-4 left-2 h-12 w-86 flex items-center bg-black/30 backdrop-blur-sm rounded-xl">
