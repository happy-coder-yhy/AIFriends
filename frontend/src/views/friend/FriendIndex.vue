...
function removeFriend(friendId: any) {
    friends.value = friends.value.filter((f: any) => f.id !== friendId)
}
...
<template>
    <div class="flex flex-col items-center b-12">
        ...
        <div v-else-if="!hasFriends" class="mt-4 text-gray-500">没有更多聊天了</div>
    </div>
</template>
